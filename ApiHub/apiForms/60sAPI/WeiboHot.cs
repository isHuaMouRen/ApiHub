...
{
    public partial class WeiboHot : Form
    {
        public class API
        {
            public class Root
        ...
        public async void RefreshAPI()
        {
            try
            {
                ...
                {
                    APIData = JsonConvert.DeserializeObject<API.Root>(await client.GetStringAsync(Main_Window.APIURL._60sAPI.weiboHot));
                }
        ...
        private void WeiboHot_Resize(object sender, EventArgs e)
        {
